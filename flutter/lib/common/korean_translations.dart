...
const Map<String, String> koreanTranslations = {
  ...
  "android_input_permission_tip1": "원격 장치에서 마우스나 터치로 Android 장치를 제어하려면 MDesk가 \"접근성\" 서비스를 사용하도록 허용해야 합니다.",
  "android_input_permission_tip2": "다음 시스템 설정 페이지로 이동하여 [설치된 앱]을 찾아 들어가서 [MDesk Host Input] 서비스를 켜세요.",
  "android_input_permission_tip_restricted": "설정 화면에 \"제한된 설정으로 제어됨\"이 표시되면 먼저 [앱 정보 열기]를 눌러 MDesk Host 앱 정보로 이동한 뒤, 우측 상단 메뉴에서 [제한된 설정 허용]을 선택하세요. 그런 다음 다시 접근성 설정에서 [MDesk Host Input]을 켜야 합니다.",
  ...
  "android_open_battery_optimizations_tip": "이 기능을 비활성화하려면 다음 MDesk 응용 프로그램 설정 페이지로 이동하여 [배터리]를 찾아서 입력하고 [제한 없음]을 선택 취소하세요",
  ...
  "scam_text1": "알지 못하고 신뢰할 수 없는 사람이 전화를 걸어 MDesk를 사용하고 서비스를 시작하라고 요청하는 경우 계속 진행하지 말고 즉시 전화를 끊으세요.",
  ...
  "upgrade_rustdesk_server_pro_to_{}_tip": "MDesk Server Pro를 {} 버전 이상으로 업그레이드하세요!",
  ...
  "upgrade_remote_rustdesk_client_to_{}_tip": "MDesk 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!",
  ...
  "allow-insecure-tls-fallback-tip": "기본적으로 MDesk는 TLS를 사용하여 프로토콜에 대한 서버 인증서를 검증합니다.\n이 옵션을 활성화하면 MDesk는 인증 단계를 건너뛰고 인증 실패 시 진행합니다.",
  ...
  "Camera is not supported in installed mode (Windows service limitation)": "설치 모드에서는 카메라가 지원되지 않습니다 (Windows 서비스 제한)",
};
