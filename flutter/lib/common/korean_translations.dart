// Generated from src/lang/ko.rs. Keep this map in sync when Korean translations change.
const Map<String, String> koreanTranslations = {
  ...
  "Ready": "준비 완료",
  "Established": "연결됨",
  "connecting_status": "MDesk 네트워크에 연결 중...",
  ...
  "id_change_tip":
      "a-z, A-Z, 0-9, -(대시) 및 _(밑줄) 문자만 허용됩니다. 첫 글자는 a-z, A-Z여야 합니다. 길이는 6에서 16 사이여야 합니다.",
  "Website": "웹사이트",
  "About": "정보",
  "Slogan_tip": "",
  ...
  "Failed to make direct connection to remote desktop":
      "원격 데스크톱에 직접 연결에 실패했습니다",
  "Set Password": "비밀번호 설정",
  "OS Password": "OS 비밀번호",
  "install_tip": "MDesk를 설치해서 원격으로 관리하시면 더욱 편리합니다",
  "Click to upgrade": "업그레이드",
  "Configure": "구성",
  "config_acc": "데스크톱을 원격으로 제어하려면 MDesk에 \"접근성\" 권한을 부여해야 합니다.",
  "config_screen": "데스크톱에 원격으로 액세스하려면 MDesk에 \"화면 녹화\" 권한을 부여해야 합니다.",
  "Installing ...": "설치 중...",
  "Install": "설치하기",
  "Installation": "설치",
  ...
  "Change Path": "경로 변경",
  "Enterprise environment settings": "기업 환경 설정",
  "Not configured": "미설정",
  "Configuration complete": "설정 완료",
  "Choose how to configure enterprise access.": "기업 접속 정보를 설정할 방법을 선택하세요.",
  "Load JSON configuration": "JSON 설정 파일 불러오기",
  "Select the JSON configuration provided by your company.":
      "기업에서 제공한 JSON 설정 파일을 선택합니다.",
  "Enter manually": "직접 입력",
  "Enter the enterprise server information manually.": "기업 서버 정보를 직접 입력합니다.",
  "Recommended": "추천",
  "Enterprise configuration loaded": "기업 설정을 불러왔습니다",
  "Enter enterprise information manually": "기업 정보 직접 입력",
  "Company name": "기업명",
  "Server public key": "서버 공개키",
  "Optional": "선택사항",
  "Invalid enterprise configuration": "잘못된 기업 설정",
  "Existing enterprise configuration": "기존 기업 설정",
  "Company name is required.": "기업명을 입력해 주세요.",
  "Server public key is required.": "서버 공개키를 입력해 주세요.",
  "Server public key must be 32 bytes.": "서버 공개키는 32바이트여야 합니다.",
  "Server public key is not valid Base64.": "서버 공개키가 올바른 Base64 형식이 아닙니다.",
  "API Server must be a valid HTTP or HTTPS URL.":
      "API 서버는 올바른 HTTP 또는 HTTPS 주소여야 합니다.",
  "A required field is missing.": "필수 입력 항목이 누락되었습니다.",
  "is required.": "주소를 입력해 주세요.",
  "Use the host:port format.": "host:port 형식으로 입력해 주세요.",
  "Invalid IPv6 address.": "IPv6 주소가 올바르지 않습니다.",
  "IPv6 addresses must be enclosed in [].": "IPv6 주소는 대괄호([])로 감싸야 합니다.",
  "Invalid host or port.": "호스트 또는 포트가 올바르지 않습니다.",
  "Create Folder": "폴더 만들기",
  "Please enter the folder name": "폴더 이름을 입력해주세요",
  "Fix it": "문제 해결",
  "Warning": "경고",
  "Login screen using Wayland is not supported":
      "Wayland를 사용한 로그인 화면은 지원되지 않습니다",
  ...
  "Closed manually by the peer": "고객이 수동으로 닫았습니다",
  ...
  "Delete from my devices": "나의 관리장치에서 삭제",
  "Delete device": "장치 삭제",
  "Are you sure to delete this device?": "이 장치를 삭제하시겠습니까?",
  "Empty": "비어 있음",
  ...
  "android_input_permission_tip1":
      "원격 장치에서 마우스나 터치로 Android 장치를 제어하려면 MDesk가 \"접근성\" 서비스를 사용하도록 허용해야 합니다.",
  "android_input_permission_tip2":
      "다음 시스템 설정 페이지로 이동하여 [설치된 앱]을 찾아 들어가서 [MDesk Host Input] 서비스를 켜세요.",
  "android_input_permission_tip_restricted":
      "설정 화면에 \"제한된 설정으로 제어됨\"이 표시되면 먼저 [앱 정보 열기]를 눌러 MDesk Host 앱 정보로 이동한 뒤, 우측 상단 메뉴에서 [제한된 설정 허용]을 선택하세요. 그런 다음 다시 접근성 설정에서 [MDesk Host Input]을 켜야 합니다.",
  "android_new_connection_tip": "현재 장치를 제어하려는 새로운 제어 요청이 수신되었습니다.",
  "android_service_will_start_tip":
      "\"화면 캡처\"를 켜면 자동으로 서비스가 시작되어 다른 장치가 내 장치에 연결을 요청할 수 있습니다.",
  "android_stop_service_tip": "서비스를 닫으면 설정된 모든 연결이 자동으로 닫힙니다.",
  "android_version_audio_tip":
      "현재 Android 버전은 오디오 캡처를 지원하지 않으므로 Android 10 이상으로 업그레이드하세요.",
  "android_start_service_tip":
      "[서비스 시작]을 탭하거나 [화면 캡처] 권한을 활성화하여 화면 공유 서비스를 시작합니다.",
  "android_permission_may_not_change_tip":
      "설정된 연결에 대한 권한은 다시 연결할 때까지 즉시 변경되지 않을 수 있습니다.",
  "Account": "계정",
  "Overwrite": "덮어쓰기",
  "This file exists, skip or overwrite this file?":
      "이 파일이 이미 존재합니다, 건너뛰거나 덮어쓰시겠습니까?",
  "Quit": "종료",
  "Help": "도움말",
  "Failed": "실패",
  "Succeeded": "성공",
  ...
  "Turned off": "꺼짐",
  "Language": "언어",
  "Keep RustDesk background service": "MDesk 백그라운드 서비스 유지",
  "Ignore Battery Optimizations": "배터리 최적화 무시",
  "android_open_battery_optimizations_tip":
      "이 기능을 비활성화하려면 다음 MDesk 응용 프로그램 설정 페이지로 이동하여 [배터리]를 찾아서 입력하고 [제한 없음]을 선택 취소하세요",
  "Start on boot": "부팅 시 시작",
  "Start the screen sharing service on boot, requires special permissions":
      "부팅 시 화면 공유 서비스를 시작하려면 특별 권한이 필요합니다",
  ...
  "remote_restarting_tip":
      "원격 장치가 다시 시작되고 있습니다. 이 메시지 상자를 닫고 잠시 후 영구 비밀번호로 다시 연결해 주세요",
  "Copied": "복사되었습니다",
  "Exit Fullscreen": "전체 화면 종료",
  "Fullscreen": "전체 화면",
  "Mobile Actions": "모바일 작업",
  "Select Monitor": "모니터 선택",
  "Switch to next monitor": "다음 모니터로 전환",
  ...
  "Recording": "녹화",
  "Directory": "디렉터리",
  "Automatically record incoming sessions": "피원격자 자동 녹화",
  "Automatically record outgoing sessions": "원격자 자동 녹화",
  "Controlled device recording location": "피원격자 녹화 저장 위치",
  "Controller recording location": "원격자 녹화 저장 위치",
  "Change": "변경",
  "Start session recording": "세션 녹화 시작",
  "Stop session recording": "세션 녹화 중지",
  "Enable recording session": "세션 녹화 사용함",
  "Ask for work details when recording ends": "녹화 종료 후 작업내용 입력",
  "Recording work note": "녹화 작업내용",
  "Video title": "영상 제목",
  "Enter a Korean video title": "영상 제목에 한글 명칭을 입력해 주세요.",
  "Work details": "작업 내용",
  "Save and close": "저장 후 종료",
  "Close without saving": "저장하지 않고 종료",
  ...
  "elevated_foreground_window_tip":
      "원격 데스크톱의 현재 창을 작동하려면 더 높은 권한이 필요하므로 일시적으로 마우스와 키보드를 사용할 수 없습니다. 원격 사용자에게 현재 창을 최소화하도록 요청하거나 연결 관리 창에서 권한 상승 버튼을 클릭할 수 있습니다. 이 문제를 방지하려면 원격 장치에 소프트웨어를 설치하는 것이 좋습니다.",
  "Disconnected": "연결 끊김",
  "Other": "기타",
  ...
  "Wayland requires Ubuntu 21.04 or higher version.":
      "Wayland는 Ubuntu 21.04 이상 버전이 필요합니다.",
  "Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.":
      "Wayland는 상위 버전의 Linux 배포판이 필요합니다. X11 데스크톱을 사용하거나 OS를 변경하세요.",
  "JumpLink": "점프 링크",
  "Please Select the screen to be shared(Operate on the peer side).":
      "공유할 화면을 선택하세요 (피어 측에서 작동)",
  "Show RustDesk": "MDesk 표시",
  "This PC": "이 PC",
  "or": "또는",
  "Continue with": "계속",
  "Elevate": "권한 상승",
  ...
  "Accept sessions via click": "'수락'버튼 클릭을 통해 세션 수락",
  "Accept sessions via both": "두 가지 방법을 통해 세션 수락",
  "Please wait for the remote side to accept your session request...":
      "원격 측에서 세션 요청을 수락할 때까지 기다려주세요...",
  ...
  "wayland_experiment_tip":
      "Wayland 지원은 실험 단계에 있으며, 무인 접근이 필요한 경우 X11을 사용해 주세요.",
  ...
  "Please login to view your peers": "피어 목록을 보려면 로그인하세요",
  "My Devices": "나의 관리장치",
  "Device registered successfully": "기기가 성공적으로 등록되었습니다",
  "Device registration failed": "기기 등록에 실패했습니다",
  "Closed manually by web console": "웹 콘솔에 의해 수동으로 닫힘",
  "Local keyboard type": "로컬 키보드 유형",
  "Select local keyboard type": "로컬 키보드 유형 선택",
  "software_render_tip":
      "Linux에서 Nvidia 그래픽 카드를 사용 중인데 원격 창이 연결 즉시 닫히는 경우 오픈 소스 Nouveau 드라이버로 전환하고 소프트웨어 렌더링을 사용하기로 선택하는 것이 도움이 될 수 있습니다. 소프트웨어를 재시작해야 합니다.",
  "Always use software rendering": "항상 소프트웨어 렌더링 사용",
  "config_input": "키보드로 원격 데스크톱을 제어하려면 MDesk에 \"입력 모니터링\" 권한을 부여해야 합니다.",
  "config_microphone": "원격으로 통화하려면 MDesk에 \"오디오 녹음\" 권한을 부여해야 합니다.",
  ...
  "Choose this if the remote account is administrator":
      "원격 계정이 관리자인 경우 이 옵션을 선택합니다",
  "Transmit the username and password of administrator": "관리자의 사용자 이름과 비밀번호 전송",
  "still_click_uac_tip": "여전히 원격 사용자가 MDesk를 실행하는 UAC 창에서 확인을 클릭해야 합니다.",
  ...
  "relay_hint_tip":
      "직접 연결이 불가능할 수 있으며 릴레이를 통해 연결을 시도할 수 있습니다. 또한 첫 번째 시도에서 릴레이를 사용하려면 아이디에 \"/r\" 접미사를 추가하거나 최근 세션 카드에 \"항상 릴레이를 통해 연결\" 옵션이 있는 경우 이 옵션을 선택하면 됩니다.",
  "Reconnect": "다시 연결",
  "Codec": "코덱",
  "Resolution": "해상도",
  ...
  "Maximize": "최대화",
  "Your Device": "내 장치",
  "empty_recent_tip": "최근 세션이 없네요!\n새로운 것을 계획할 시간입니다.",
  "empty_favorite_tip": "아직 즐겨찾는 고객이 없나요?\n연결하고 싶은 고객을 찾아 즐겨찾기에 추가해 보세요!",
  "empty_lan_tip": "로컬 네트워크 환경에서 원격이 가능한 피어를 발견하지 못하였습니다.",
  "empty_address_book_tip": "주소록에 현재 나열된 고객이 없는 것 같습니다.",
  ...
  "verify_rustdesk_password_tip": "MDesk 비밀번호 확인",
  ...
  "selinux_tip": "SELinux가 장치에서 활성화되어 있어 MDesk가 제어된 상태로 제대로 작동하지 않을 수 있습니다.",
  "Change view": "보기 변경",
  "Big tiles": "큰 타일",
  "Small tiles": "작은 타일",
  "List": "목록",
  ...
  "idd_not_support_under_win10_2004_tip":
      "간접 디스플레이 드라이버는 지원되지 않습니다. Windows 10 버전 2004 이상이 필요합니다.",
  ...
  "enable-2fa-desc":
      "지금 인증앱을 설정해 주세요. 휴대폰이나 데스크톱에서 Authy, Microsoft 또는 Google 인증기와 같은 인증기 앱을 사용할 수 있습니다.\n\n앱으로 QR 코드를 스캔하고 앱에 표시된 코드를 입력하면 이중 인증이 가능합니다.",
  ...
  "powered_by_me": "MDesk 제공",
  "outgoing_only_desk_tip":
      "이것은 맞춤형 에디션입니다.\n다른 장치에 연결할 수는 있지만 귀하의 기기에 연결할 수 없습니다.",
  "preset_password_warning":
      "이 맞춤형 에디션에는 미리 설정된 비밀번호가 함께 제공됩니다. 이 비밀번호를 아는 사람이라면 누구나 기기를 완전히 제어할 수 있습니다. 예상치 못한 경우 즉시 소프트웨어를 제거하세요.",
  ...
  "allow-only-conn-window-open-tip": "MDesk 창이 열려 있을 때만 연결 허용",
  "no_need_privacy_mode_no_physical_displays_tip":
      "실제 디스플레이가 없으므로 개인 정보 보호 모드를 사용할 필요가 없습니다.",
  ...
  "texture_render_tip":
      "텍스처 렌더링을 사용하여 사진을 더 부드럽게 만듭니다. 렌더링 문제가 발생하면 이 옵션을 비활성화할 수 있습니다.",
  "Use texture rendering": "텍스처 렌더링 사용",
  "Floating window": "플로팅 창",
  "floating_window_tip": "MDesk 백그라운드 서비스를 유지하는 데 도움이 됩니다",
  ...
  "enable-bot-tip":
      "이 기능을 활성화하면 봇에서 이중 인중 코드를 받을 수 있습니다. 또한 연결 알림 기능도 할 수 있습니다.",
  "enable-bot-desc":
  ...
  "About RustDesk": "MDesk 정보",
  "About MDesk": "MDesk 정보",
  ...
  "Accessible devices": "접근 가능한 기기",
  "upgrade_remote_rustdesk_client_to_{}_tip":
      "MDesk 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!",
  ...
  "printer-requires-installed-{}-client-tip":
      "원격 인쇄 기능을 사용하려면 이 장치에 {}를 설치해야 합니다.",
  ...
  "screenshot-merged-screen-not-supported-tip":
      "현재 다중 디스플레이의 스크린샷 병합이 지원되지 않습니다. 단일 디스플레이로 전환한 후 다시 시도해 주세요.",
  ...
  "download-new-version-failed-tip":
      "다운로드에 실패했습니다. 다시 시도하거나 \"다운로드\" 버튼을 클릭하여 릴리스 페이지에서 다운로드하고 수동으로 업그레이드할 수 있습니다.",
  "Auto update": "자동 업데이트",
  "update-failed-check-msi-tip":
      "설치 방법 확인에 실패했습니다. \"다운로드\" 버튼을 클릭하여 릴리스 페이지에서 다운로드하고 수동으로 업그레이드하세요.",
  ...
  "allow-insecure-tls-fallback-tip":
      "기본적으로 MDesk는 TLS를 사용하여 프로토콜에 대한 서버 인증서를 검증합니다.\n이 옵션을 활성화하면 MDesk는 인증 단계를 건너뛰고 인증 실패 시 진행합니다.",
  "Disable UDP": "UDP 사용 안 함",
  "disable-udp-tip":
      "TCP만 사용할지 여부를 제어합니다.\n이 옵션을 활성화하면 MDesk는 더 이상 UDP 2116을 사용하지 않고 대신 TCP 2116을 사용합니다.",
  "server-oss-not-support-tip": "참고: MDesk 서버 OSS에는 이 기능이 포함되어 있지 않습니다.",
  "input note here": "여기에 노트 입력",
  "note-at-conn-end-tip": "연결이 끝날 때 메모 요청",
  "Custom Remote": "사용자 정의 원격",
  "Login to access custom remote connections": "사용자 정의 원격 연결에 액세스하려면 로그인하세요",
  "Camera is not supported in installed mode (Windows service limitation)":
      "설치 모드에서는 카메라가 지원되지 않습니다 (Windows 서비스 제한)",
};
