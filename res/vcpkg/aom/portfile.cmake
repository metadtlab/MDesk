...
set(aom_target_cpu "")
if(
    VCPKG_TARGET_IS_UWP OR
    (VCPKG_TARGET_IS_WINDOWS AND VCPKG_TARGET_ARCHITECTURE MATCHES "^arm") OR
    (VCPKG_TARGET_IS_ANDROID AND VCPKG_TARGET_ARCHITECTURE MATCHES "^arm")
)
    # UWP + aom's assembler files result in weirdness and build failures.
    # Android ARM64 can also end up resolving ASM to plain "as" during configure.
