...
fn wire_host_activate_korean_input_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool>(
        WrapInfo {
            debug_name: "host_activate_korean_input",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(host_activate_korean_input()),
    )
}
...
fn wire_session_take_screenshot_data_impl(
    port_: MessagePort,
    session_id: impl Wire2Api<uuid::Uuid> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "session_take_screenshot_data",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_session_id = session_id.wire2api();
            move |task_callback| Ok(session_take_screenshot_data(api_session_id))
        },
    )
}
fn wire_main_save_png_file_impl(
    port_: MessagePort,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        ...
        move || {
            ...
            move |task_callback| Ok(main_save_png_file(api_path, api_data))
        },
    )
}
fn wire_main_set_png_clipboard_impl(port_: MessagePort, data: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_set_png_clipboard",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_data = data.wire2api();
            move |task_callback| Ok(main_set_png_clipboard(api_data))
        },
    )
}
fn wire_main_set_rgba_clipboard_impl(
    port_: MessagePort,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_set_rgba_clipboard",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_data = data.wire2api();
            move |task_callback| Ok(main_set_rgba_clipboard(api_width, api_height, api_data))
        },
    )
}
...
fn wire_session_save_recording_note_impl(
    port_: MessagePort,
    session_id: impl Wire2Api<uuid::Uuid> + UnwindSafe,
    title: impl Wire2Api<String> + UnwindSafe,
    comment: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "session_save_recording_note",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            move |task_callback| {
                Ok(session_save_recording_note(
                    api_session_id,
                    api_title,
                    api_comment,
                ))
...
fn wire_main_get_remote_users_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_get_remote_users",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(main_get_remote_users()),
    )
}
fn wire_main_add_remote_user_impl(
    port_: MessagePort,
    id: impl Wire2Api<String> + UnwindSafe,
    name: impl Wire2Api<String> + UnwindSafe,
    connection_password: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "main_add_remote_user",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_id = id.wire2api();
            let api_name = name.wire2api();
            let api_connection_password = connection_password.wire2api();
            move |task_callback| {
                Ok(main_add_remote_user(
                    api_id,
                    api_name,
                    api_connection_password,
                ))
            }
        },
    )
}
fn wire_main_update_remote_user_impl(
    port_: MessagePort,
    id: impl Wire2Api<String> + UnwindSafe,
    name: impl Wire2Api<String> + UnwindSafe,
    connection_password: impl Wire2Api<String> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "main_update_remote_user",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_main_remove_remote_user_impl(port_: MessagePort, id: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "main_remove_remote_user",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_id = id.wire2api();
            move |task_callback| Ok(main_remove_remote_user(api_id))
        },
    )
}
fn wire_main_verify_remote_user_impl(
    port_: MessagePort,
    id: impl Wire2Api<String> + UnwindSafe,
    connection_password: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool>(
        WrapInfo {
            debug_name: "main_verify_remote_user",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_id = id.wire2api();
            let api_connection_password = connection_password.wire2api();
            move |task_callback| Ok(main_verify_remote_user(api_id, api_connection_password))
        },
    )
}
...
fn wire_main_get_exe_name_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "main_get_exe_name",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(main_get_exe_name()),
    )
}
...
fn wire_main_change_language_impl(port_: MessagePort, _lang: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
        ...
        move || {
            let api__lang = _lang.wire2api();
            move |task_callback| Ok(main_change_language(api__lang))
        },
    )
}
...
fn wire_whiteboard_send_draw_impl(
    port_: MessagePort,
    conn_id: impl Wire2Api<i32> + UnwindSafe,
    points: impl Wire2Api<String> + UnwindSafe,
    argb: impl Wire2Api<u32> + UnwindSafe,
    stroke_width: impl Wire2Api<f32> + UnwindSafe,
    tool: impl Wire2Api<u8> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "whiteboard_send_draw",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_stroke_width = stroke_width.wire2api();
            let api_tool = tool.wire2api();
            move |task_callback| {
                Ok(whiteboard_send_draw(
                    api_conn_id,
                    api_points,
                    api_argb,
                    api_stroke_width,
...
fn wire_whiteboard_clear_draw_impl(port_: MessagePort, conn_id: impl Wire2Api<i32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "whiteboard_clear_draw",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_conn_id = conn_id.wire2api();
            move |task_callback| Ok(whiteboard_clear_draw(api_conn_id))
        },
    )
}
fn wire_whiteboard_undo_draw_impl(port_: MessagePort, conn_id: impl Wire2Api<i32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "whiteboard_undo_draw",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_conn_id = conn_id.wire2api();
            move |task_callback| Ok(whiteboard_undo_draw(api_conn_id))
        },
    )
}
fn wire_whiteboard_register_impl(port_: MessagePort, conn_id: impl Wire2Api<i32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "whiteboard_register",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_conn_id = conn_id.wire2api();
            move |task_callback| Ok(whiteboard_register(api_conn_id))
        },
    )
}
fn wire_whiteboard_unregister_impl(port_: MessagePort, conn_id: impl Wire2Api<i32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "whiteboard_unregister",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_conn_id = conn_id.wire2api();
            move |task_callback| Ok(whiteboard_unregister(api_conn_id))
        },
    )
}
...
fn wire_main_is_portable_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "main_is_portable",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(main_is_portable()),
    )
}
fn wire_main_cleanup_portable_config_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "main_cleanup_portable_config",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(main_cleanup_portable_config()),
    )
}
...
fn wire_main_register_device_impl(
    port_: MessagePort,
    user_id: impl Wire2Api<String> + UnwindSafe,
    user_pkid: impl Wire2Api<String> + UnwindSafe,
    remote_id: impl Wire2Api<String> + UnwindSafe,
    alias: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_register_device",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_user_id = user_id.wire2api();
            let api_user_pkid = user_pkid.wire2api();
            let api_remote_id = remote_id.wire2api();
            let api_alias = alias.wire2api();
            move |task_callback| {
                Ok(main_register_device(
                    api_user_id,
                    api_user_pkid,
                    api_remote_id,
                    api_alias,
...
fn wire_main_unregister_device_impl(
    port_: MessagePort,
    user_pkid: impl Wire2Api<String> + UnwindSafe,
    remote_id: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_unregister_device",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_user_pkid = user_pkid.wire2api();
            let api_remote_id = remote_id.wire2api();
            move |task_callback| Ok(main_unregister_device(api_user_pkid, api_remote_id))
        },
    )
}
fn wire_main_get_registered_devices_impl(
    port_: MessagePort,
    user_pkid: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_get_registered_devices",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_user_pkid = user_pkid.wire2api();
            move |task_callback| Ok(main_get_registered_devices(api_user_pkid))
        },
    )
}
