...
#[no_mangle]
pub extern "C" fn wire_host_activate_korean_input(port_: i64) {
    wire_host_activate_korean_input_impl(port_)
}
...
#[no_mangle]
pub extern "C" fn wire_session_take_screenshot_data(port_: i64, session_id: *mut wire_uint_8_list) {
    wire_session_take_screenshot_data_impl(port_, session_id)
}

#[no_mangle]
pub extern "C" fn wire_main_save_png_file(
    port_: i64,
    path: *mut wire_uint_8_list,
    data: *mut wire_uint_8_list,
) {
    wire_main_save_png_file_impl(port_, path, data)
}

#[no_mangle]
pub extern "C" fn wire_main_set_png_clipboard(port_: i64, data: *mut wire_uint_8_list) {
    wire_main_set_png_clipboard_impl(port_, data)
}

#[no_mangle]
pub extern "C" fn wire_main_set_rgba_clipboard(
    port_: i64,
    width: usize,
    height: usize,
    data: *mut wire_uint_8_list,
) {
    wire_main_set_rgba_clipboard_impl(port_, width, height, data)
}
...
#[no_mangle]
pub extern "C" fn wire_session_save_recording_note(
    port_: i64,
    session_id: *mut wire_uint_8_list,
    title: *mut wire_uint_8_list,
    comment: *mut wire_uint_8_list,
) {
    wire_session_save_recording_note_impl(port_, session_id, title, comment)
}
...
#[no_mangle]
pub extern "C" fn wire_main_get_remote_users(port_: i64) {
    wire_main_get_remote_users_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_main_add_remote_user(
    port_: i64,
    id: *mut wire_uint_8_list,
    name: *mut wire_uint_8_list,
    connection_password: *mut wire_uint_8_list,
) {
    wire_main_add_remote_user_impl(port_, id, name, connection_password)
}

#[no_mangle]
pub extern "C" fn wire_main_update_remote_user(
    port_: i64,
    id: *mut wire_uint_8_list,
    name: *mut wire_uint_8_list,
    connection_password: *mut wire_uint_8_list,
) {
    wire_main_update_remote_user_impl(port_, id, name, connection_password)
}

#[no_mangle]
pub extern "C" fn wire_main_remove_remote_user(port_: i64, id: *mut wire_uint_8_list) {
    wire_main_remove_remote_user_impl(port_, id)
}

#[no_mangle]
pub extern "C" fn wire_main_verify_remote_user(
    port_: i64,
    id: *mut wire_uint_8_list,
    connection_password: *mut wire_uint_8_list,
) {
    wire_main_verify_remote_user_impl(port_, id, connection_password)
}
...
#[no_mangle]
pub extern "C" fn wire_main_get_exe_name() -> support::WireSyncReturn {
    wire_main_get_exe_name_impl()
}
...
#[no_mangle]
pub extern "C" fn wire_main_change_language(port_: i64, _lang: *mut wire_uint_8_list) {
    wire_main_change_language_impl(port_, _lang)
}
...
#[no_mangle]
pub extern "C" fn wire_whiteboard_send_draw(
    port_: i64,
    conn_id: i32,
    ...
    wire_whiteboard_send_draw_impl(port_, conn_id, points, argb, stroke_width, tool)
}

#[no_mangle]
pub extern "C" fn wire_whiteboard_clear_draw(port_: i64, conn_id: i32) {
    wire_whiteboard_clear_draw_impl(port_, conn_id)
}

#[no_mangle]
pub extern "C" fn wire_whiteboard_undo_draw(port_: i64, conn_id: i32) {
    wire_whiteboard_undo_draw_impl(port_, conn_id)
}

#[no_mangle]
pub extern "C" fn wire_whiteboard_register(port_: i64, conn_id: i32) {
    wire_whiteboard_register_impl(port_, conn_id)
}

#[no_mangle]
pub extern "C" fn wire_whiteboard_unregister(port_: i64, conn_id: i32) {
    wire_whiteboard_unregister_impl(port_, conn_id)
}
...
#[no_mangle]
pub extern "C" fn wire_main_is_portable() -> support::WireSyncReturn {
    wire_main_is_portable_impl()
}

#[no_mangle]
pub extern "C" fn wire_main_cleanup_portable_config() -> support::WireSyncReturn {
    wire_main_cleanup_portable_config_impl()
}
...
#[no_mangle]
pub extern "C" fn wire_main_register_device(
    port_: i64,
    user_id: *mut wire_uint_8_list,
    user_pkid: *mut wire_uint_8_list,
    remote_id: *mut wire_uint_8_list,
    alias: *mut wire_uint_8_list,
) {
    wire_main_register_device_impl(port_, user_id, user_pkid, remote_id, alias)
}

#[no_mangle]
pub extern "C" fn wire_main_unregister_device(
    port_: i64,
    user_pkid: *mut wire_uint_8_list,
    remote_id: *mut wire_uint_8_list,
) {
    wire_main_unregister_device_impl(port_, user_pkid, remote_id)
}

#[no_mangle]
pub extern "C" fn wire_main_get_registered_devices(port_: i64, user_pkid: *mut wire_uint_8_list) {
    wire_main_get_registered_devices_impl(port_, user_pkid)
}
