  ...
  : Fl_Window(450, 0, "MDesk - Device")
{
  ...
  serverName = new Fl_Suggestion_Input(
    LBLLEFT(x, y, w() - OUTER_MARGIN*2, INPUT_HEIGHT, _("Device :")), {}
  );
  ...
  button = new Fl_Button(x2, y, BUTTON_WIDTH, BUTTON_HEIGHT, _("취소"));
  button->callback(this->handleCancel, this);
  x2 += BUTTON_WIDTH + INNER_MARGIN;

  button = new Fl_Return_Button(x2, y, BUTTON_WIDTH, BUTTON_HEIGHT, _("연결"));
