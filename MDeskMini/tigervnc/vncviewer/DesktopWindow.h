...
private:
  ...
  static void handleErrorLookup(Fl_Widget *wnd, void *data);
  static void handleLookupResult(void *data);
  static void handleDriverOpen(Fl_Widget *wnd, void *data);
  void lookupErrorCode();
  void startDriverLookup();
...
private:
  ...
  Fl_Group *aiBar;
  Fl_Box *errorCodeLabel;
  Fl_Input *errorCodeInput;
  Fl_Button *errorLookupButton;
  Fl_Button *driverButton;
  Fl_Multiline_Output *aiOutput;

  bool errorLookupActive;
  std::string driverUrl;
  std::shared_ptr<LookupAsyncState> lookupAsyncState;
