...
OptionsDialog::OptionsDialog()
  : Fl_Window(580, 420, _("MDesk - Device options"))
{
  int x, y;
...
void OptionsDialog::loadOptions(void)
{
  ...
  } else if (cursorType == "highcontrast") {
    cursorTypeChoice->value(2);
  } else {
    // Default
...
void OptionsDialog::storeOptions(void)
{
  ...
  } else if (cursorTypeChoice->value() == 2) {
    cursorType.setParam("HighContrast");
  } else {
    // Default
...
void OptionsDialog::createInputPage(int tx, int ty, int tw, int th)
{
...

  {
    ...
    fltk_menu_add(cursorTypeChoice, _("High contrast"), 0, nullptr, nullptr, 0);
